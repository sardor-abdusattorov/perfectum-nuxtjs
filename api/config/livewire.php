...
return [
    ...
    */
    ...
    |
    | The rich editor keeps its live state as a TipTap document, so a single
    | word inside a bullet inside a repeater row inside a translated field is
    | already a dozen levels deep — the shipped depth of 10 refuses to save the
    | home page. The size follows for the same reason: one long article is a
    | tree of nodes, and it travels with every other field of the form.
    |
    */

    'payload' => [
        'max_size' => 8 * 1024 * 1024, // 8MB - maximum request payload size in bytes
        'max_nesting_depth' => 64,     // Maximum depth of dot-notation property paths
