...
class SiteTranslationSeeder extends Seeder
{
    ...
    private function lines(): array
    {
        return [
            ...
            'help.numbers_unavailable' => ['ru' => 'Подбор номеров временно недоступен. Попробуйте позже или обратитесь в офис.', 'uz' => 'Raqam tanlash vaqtincha ishlamayapti. Keyinroq urinib koʻring yoki ofisga murojaat qiling.'],
            ...
            'numbers.unavailable' => ['ru' => 'Подбор номеров временно недоступен. Попробуйте позже или обратитесь в офис.', 'uz' => 'Raqam tanlash vaqtincha ishlamayapti. Keyinroq urinib koʻring yoki ofisga murojaat qiling.'],
