...
useSeo({ title: "Perfectum | Частые вопросы" })
</script>
          ...
          <div class="help__panel">
              ...
              <div class="help__content">
                  <div class="help__tab help__tab_active">
                      <h2 class="help__tab-title">Часто задаваемые вопросы</h2>
                      <div class="faq-accordion">
                          <details class="faq-item">
                              ...
                              <div class="faq-item__answer">
                                  <p>Оставьте заявку на сайте или в мобильном приложении Perfectum — менеджер
                                      свяжется с вами и поможет выбрать тариф и оформить подключение.</p>
                              </div>
                          </details>
                          <details class="faq-item">
                              <summary class="faq-item__summary">
                                  <span class="faq-item__question">Как узнать, есть ли покрытие 5G SA по моему
                                      адресу?</span>
                                  <span class="faq-item__toggle" aria-hidden="true">
                                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2"
                              ...
                              <div class="faq-item__answer">
                                  <p>Проверьте доступность сети на странице «Карта покрытия» — выберите город
                                      и посмотрите зону обслуживания 5G Standalone.</p>
                              </div>
                          </details>
                          <details class="faq-item">
                              <summary class="faq-item__summary">
                                  <span class="faq-item__question">Что такое eSIM и как её оформить?</span>
                                  <span class="faq-item__toggle" aria-hidden="true">
                                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2"
                                              stroke-linecap="round" />
                              ...
                              <div class="faq-item__answer">
                                  <p>eSIM — это цифровая SIM-карта без физического носителя. Оформить её можно
                                      полностью онлайн в приложении Perfectum на устройстве с поддержкой eSIM.
                                  </p>
                              </div>
                          </details>
                          <details class="faq-item">
                              ...
                              <div class="faq-item__answer">
                                  <p>Сменить тариф можно в личном кабинете или мобильном приложении в разделе
                                      «Тариф» — новый план активируется в течение нескольких минут.</p>
                              </div>
                          </details>
                          <details class="faq-item">
                              <summary class="faq-item__summary">
                              ...
                              <div class="faq-item__answer">
                                  <p>Позвоните на короткий номер 077 (бесплатно с номеров Perfectum), напишите
                                      в Telegram @Perfectum_Support или оставьте заявку во вкладке «Связь с
                                      нами».</p>
                              </div>
                          </details>
                      </div>
