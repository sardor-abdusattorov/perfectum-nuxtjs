...
useSeo({ title: "Perfectum | Карьера" })
</script>
      ...
      <div class="container">
          <div class="page-hero__inner">
              <nav class="page-hero__crumbs" aria-label="Хлебные крошки">
                  ...
                  <span class="page-hero__crumb page-hero__crumb_current" aria-current="page">Карьера</span>
              </nav>
              <p class="page-hero__eyebrow page-hero__eyebrow_silver">Работа в Perfectum</p>
              <h1 class="page-hero__title section__title">Карьера в <span
                      class="page-hero__title-red">Perfectum</span></h1>
              <p class="page-hero__subtitle">Открытые позиции и жизнь внутри компании.</p>
          </div>
      </div>
  </section>
  ...
  <section class="company">
      <div class="container">
          <nav class="company-nav" aria-label="Разделы о компании">
              ...
              <NuxtLink class="company-nav__tab company-nav__tab_active" :to="localePath('/careers')">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                      fill="none">
          ...
          <div class="careers-intro">
              <h2 class="careers-intro__title">Строим первую сеть 5G Standalone в Центральной Азии — и нам
                  нужны амбициозные люди.</h2>
              <p class="careers-intro__text">Открытые позиции в инженерии, продукте, коммерции и поддержке
                  клиентов.</p>
          </div>

          <!-- VACANCIES -->
          <ul class="vac-list">
              <li><NuxtLink class="vac-row" :to="localePath('/careers/example')">
                      <span class="vac-row__body">
                          <h2 class="vac-row__title">Инженер по эксплуатации сети 5G SA</h2>
                          <span class="vac-row__meta">
                              <span class="vac-row__tag">Технический департамент</span>
                              <span class="vac-row__tag">Ташкент</span>
                              <span class="vac-row__tag">Полная занятость</span>
                          </span>
                      </span>
              ...
              <li><NuxtLink class="vac-row" :to="localePath('/careers/example')">
                      <span class="vac-row__body">
                          <h2 class="vac-row__title">Менеджер по продукту (мобильное приложение)</h2>
                          <span class="vac-row__meta">
                              <span class="vac-row__tag">Продукт</span>
                              <span class="vac-row__tag">Ташкент</span>
                              <span class="vac-row__tag">Полная занятость</span>
                          </span>
                      </span>
              ...
              <li><NuxtLink class="vac-row vac-row_active" :to="localePath('/careers/example')">
                      <span class="vac-row__body">
                          <h2 class="vac-row__title">Специалист поддержки контакт-центра</h2>
                          <span class="vac-row__meta">
                              <span class="vac-row__tag">Клиентский сервис</span>
                              <span class="vac-row__tag">Ташкент</span>
                              <span class="vac-row__tag">Полная занятость</span>
                          </span>
                      </span>
              ...
              <li><NuxtLink class="vac-row" :to="localePath('/careers/example')">
                      <span class="vac-row__body">
                          <h2 class="vac-row__title">Менеджер по работе с дилерами</h2>
                          <span class="vac-row__meta">
                              <span class="vac-row__tag">Коммерция</span>
                              <span class="vac-row__tag">Самарканд</span>
                              <span class="vac-row__tag">Полная занятость</span>
                          </span>
                      </span>
                      <span class="vac-row__arrow" aria-hidden="true">
              ...
              <li><NuxtLink class="vac-row" :to="localePath('/careers/example')">
                      <span class="vac-row__body">
                          <h2 class="vac-row__title">SMM-менеджер</h2>
                          <span class="vac-row__meta">
                              <span class="vac-row__tag">Маркетинг</span>
                              <span class="vac-row__tag">Ташкент</span>
                              <span class="vac-row__tag">Полная занятость</span>
                          </span>
                      </span>
