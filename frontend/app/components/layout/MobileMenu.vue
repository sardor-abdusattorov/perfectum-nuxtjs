  ...
  <div class="menu">
      <div class="menu__panel">
          <div class="menu__head">
              ...
              <button type="button" class="menu__close" :aria-label="t('header.close_menu', 'Закрыть')">
          ...
          <ul class="menu__list">
              <li
                  ...
                  :key="item.id"
                  class="menu__item"
                  :class="item.children.length && 'menu__item_has-submenu'"
              >
                  <button v-if="item.children.length" type="button" class="menu__link menu__link_toggle">
                      {{ item.name }}
                  </button>
